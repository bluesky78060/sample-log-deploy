 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lt{constructor(e){this.fields=e,e.sort(me.comparator)}static empty(){return new lt([])}unionWith(e){let t=new oe(me.comparator);for(const n of this.fields)t=t.add(n);for(const n of e)t=t.add(n);return new lt(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return pi(this.fields,e.fields,(t,n)=>t.isEqual(n))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x_(r){var t,n;if(q(r instanceof ee||r instanceof se,20012),r instanceof ee){if(r instanceof Jy){const i=((n=(t=r.value.arrayValue)==null?void 0:t.values)==null?void 0:n.map(s=>ee.create(r.field,"==",s)))||[];return se.create(i,"or")}return r}const e=r.filters.map(i=>x_(i));return se.create(e,r.op)}function CP(r){if(r.getFilters().length===0)return[];const e=pu(x_(r));return q(N_(e),7391),du(e)||fu(e)?[e]:e.getFilters()}function du(r){return r instanceof ee}function fu(r){return r instanceof se&&_h(r)}function N_(r){return du(r)||fu(r)||function(t){if(t instanceof se&&iu(t)){for(const n of t.getFilters())if(!du(n)&&!fu(n))return!1;return!0}return!1}(r)}function pu(r){if(q(r instanceof ee||r instanceof se,34018),r instanceof ee)return r;if(r.filters.length===1)return pu(r.filters[0]);const e=r.filters.map(n=>pu(n));let t=se.create(e,r.op);return t=qa(t),N_(t)?t:(q(t instanceof se,64498),q(vi(t),40251),q(t.filters.length>1,57927),t.filters.reduce((n,i)=>Ch(n,i)))}function Ch(r,e){let t;return q(r instanceof ee||r instanceof se,38388),q(e instanceof ee||e instanceof se,25473),t=r instanceof ee?e instanceof ee?function(i,s){return se.create([i,s],"and")}(r,e):Xp(r,e):e instanceof ee?Xp(e,r):function(i,s){if(q(i.filters.length>0&&s.filters.length>0,48005),vi(i)&&vi(s))return Hy(i,s.getFilters());const o=iu(i)?i:s,c=iu(i)?s:i,l=o.filters.map(u=>Ch(u,c));return se.create(l,"or")}(r,e),qa(t)}function Xp(r,e){if(vi(e))return Hy(e,r.getFilters());{const t=e.filters.map(n=>Ch(r,n));return se.create(t,"or")}}function qa(r){if(q(r instanceof ee||r instanceof se,11850),r instanceof ee)return r;const e=r.getFilters();if(e.length===1)return qa(e[0]);if(Gy(r))return r;const t=e.map(i=>qa(i)),n=[];return t.forEach(i=>{i instanceof ee?n.push(i):i instanceof se&&(i.op===r.op?n.push(...i.filters):n.push(i))}),n.length===1?n[0]:se.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
