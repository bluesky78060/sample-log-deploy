 ...
 */
export function setContent(element: HTMLElement | null, content: string, isHTML: boolean = false): void {
    if (!element) return;
 ...
 */
export function enableInnerHTMLWarning(enable: boolean = true): void {
...
interface DOMUtils {
    ...
    replaceHTML: typeof replaceHTML;
    setContent: typeof setContent;
    renderList: typeof renderList;
    enableInnerHTMLWarning: typeof enableInnerHTMLWarning;
}
