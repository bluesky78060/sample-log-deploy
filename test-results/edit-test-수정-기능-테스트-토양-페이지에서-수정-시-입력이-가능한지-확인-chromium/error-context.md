...
- generic [ref=e1]:
  - navigation [ref=e2]:
    ...
    - generic [ref=e10]:
      - button "edit_note 접수" [ref=e11] [cursor=pointer]:
        ...
        - generic: 접수
      - button "table_rows 목록" [active] [ref=e13] [cursor=pointer]:
  ...
  - main [ref=e47]:
    ...
    - generic [ref=e48]:
      - generic [ref=e49]:
        - generic [ref=e50]:
          - heading "토양 접수 목록" [level=2] [ref=e51]
          ...
          - generic [ref=e55]: 0건
        - generic [ref=e56]:
          - button "👁️ 전체 보기" [ref=e58] [cursor=pointer]:
            - generic [ref=e59]: 👁️
            - generic [ref=e60]: 전체 보기
          - button "📊 통계" [ref=e61] [cursor=pointer]
          - button "🏷️ 라벨 인쇄" [ref=e62] [cursor=pointer]
          - button "🗑️ 선택 삭제" [ref=e63] [cursor=pointer]
          - button "📮 발송일자" [ref=e64] [cursor=pointer]
          - button "🔍 검색" [ref=e65] [cursor=pointer]
      - generic [ref=e67]:
        - generic [ref=e68]: 📭
        - paragraph [ref=e69]: 등록된 접수 내역이 없습니다
        - button "새 시료 접수하기" [ref=e70] [cursor=pointer]
  - generic:
    - generic:
      - paragraph: 처리 중...
```